...
"""
function run_for_all_triangles!(g::MeshGraph, fun; log=false)
    ran = false
...
"""
function refine!(g::MeshGraph; log=false)
    while true
        ran = false
...
```
"""
function subdivie(g::MeshGraph, iters)
    for _ in 1:iters

    end
end

function points_in_subdivided(g::MeshGraph, interior, iters)
